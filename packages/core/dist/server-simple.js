...
export class SimpleBrainSlotServer {
    ...
    setupTools() {
        ...
        this.sdkServer.tool('bs.create_dataset', 'Crea un dataset a partir de fuentes existentes', async (args) => {
            const { name = 'unnamed-dataset', sourceIds = [] } = args;
        ...
        // bs.ingest_url tool
        this.sdkServer.tool('bs.ingest_url', 'Ingesta una URL y crea fuentes para datasets', async (args) => {
            const { url = 'https://example.com', rules = {} } = args;
        ...
        this.sdkServer.tool('bs.query_entity', 'Consulta a una Entidad usando su contexto entrenado', async (args) => {
            const { entityId = 'default-entity', query = 'test query', topK = 5 } = args;
        ...
        this.sdkServer.tool('bs.train_entity', 'Entrena una Entidad con un dataset', async (args) => {
            const { entityId = 'default-entity', datasetId = 'default-dataset', strategy = 'rag' } = args;
