import type { ResourceDescriptor, ResourceTemplate, ServerContext } from "./types";

export function baseResourceTemplates(): ResourceTemplate[] {
  return [
...
export function seedResources(ctx: ServerContext): ResourceDescriptor[] {
  return [
